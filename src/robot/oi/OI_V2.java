...
public class OI_V2 {
	...
	public boolean getTurbo() {
		return driverStick.getButton(Trigger.RIGHT);
	}
	...
	public boolean getArmDeploy() {
		return driverStick.getButton(Button.LEFT_BUMPER);
	}
	...
	/*
	 * TODO:
	 * public boolean portCButton() {
	 * 	return operatorStick.getRawButton(12);
	 * }
	 *
	 * public boolean chavelButton() {
	 * 	return operatorStick.getRawButton(11);
	 * }
	 * 
	 * public boolean lowBarButton() {
	 * 	return operatorStick.getRawButton(12);
	 * }
	 */
	
	// TODO: Make a seperate reverse rollers function - Slower than low goal button?
