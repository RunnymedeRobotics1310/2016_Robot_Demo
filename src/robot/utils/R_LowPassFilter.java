...
public class R_LowPassFilter {
	 ...
	 * 
	 * where tau = 1 / f-cutoff T = sample time
	 */

	/**
	 * @param cutOffFrequency
	 *            The frequency (in Hz) that should be used for cut off.
	 * @param sampleTime
	 *            The time (in seconds) that your data is sampled.
	 * @param maxIncrement
	 *            The maximum increment expected in the input in any one sample.
	 *            If the input step exceeds this maximum, the sample is not
	 *            used, and the previous input sample is used instead. If the
	 *            sample occurs again, then this new value is used as the new
	 *            baseline.
	 */
	 ...
	 * 
	 * @param x
	 *            The input to pass to the filter
